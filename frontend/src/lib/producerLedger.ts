...
export const PRODUCER_LEDGER_ADDRESS = '0x19dc4197F13dD63dA63Dc124D7f41c69AAcb8AA2'
...
export const LEDGER_ERROR_MESSAGES: Record<string, string> = {
  '0x6a43f8d1': '생산자 단가가 온체인에 없습니다. 생산자 탭에서 MetaMask 연결 후 단가를 저장해 주세요.',
  '0xf499da20': 'WON 잔액 부족입니다. approve 후 다시 시도해 주세요.',
